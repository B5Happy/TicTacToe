...
public class ManagerVF : MonoBehaviour {
   ...
   /* private void Start()
    ...
    public void ConterPlay()
    {
        ...
        GameObject.Find("Panel").GetComponentInChildren<Text>().text = "O";
        GameObject.Find("Panel").GetComponent<Button>().interactable = false;
      

        Data[int.Parse(gameObject.name)] = "O";
